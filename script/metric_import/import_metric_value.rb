...
Card::Auth.as_bot do
  ...
  CSV.foreach(("script/metric_import/metric_to_import_20150803.csv"),:encoding => 'windows-1251:utf-8',:headers => true, :header_converters => :symbol, :converters => :all) do |row|
