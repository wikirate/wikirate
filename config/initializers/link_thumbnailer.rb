...
LinkThumbnailer.configure do |config|
  # Numbers of redirects before raising an exception
  # when trying to parse given url.
  ...
  # List of procedures used to rate the website description.
  # Add you custom class here. Note that the order matter to compute the score.
  # See wiki for more details on how to build your own graders.
  #
  # config.graders = [
  #   ->(description) { ::LinkThumbnailer::Graders::Length.new(description) },
  #   ->(description) {
  #     ::LinkThumbnailer::Graders::HtmlAttribute.new(description, :class) },
  #   ->(description) {
  #     ::LinkThumbnailer::Graders::HtmlAttribute.new(description, :id) },
  #   ->(description) { ::LinkThumbnailer::Graders::Position.new(description) },
  #   ->(description) {
  #     ::LinkThumbnailer::Graders::LinkDensity.new(description) }
  # ]
  ...
  # Setting this value to false will increase performance since for each
  # images, LinkThumbnailer does not have to fetch its size and type.
  #
