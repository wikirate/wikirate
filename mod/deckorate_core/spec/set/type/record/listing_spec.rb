...
RSpec.describe Card::Set::Type::Record::Listing do
  ...
  describe "view :concise" do
    ...
    context "with single category metric" do
      subject { concise_record_for "Joe User+big single" }
