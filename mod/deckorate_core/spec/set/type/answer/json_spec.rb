RSpec.describe Card::Set::Type::Answer::Json do
  YEAR = 1977
  ...
  describe "exported json researched answer" do
    ...
    let(:atom_fields) do
      {
        ...
        year: YEAR,
        value: "Darth Sidious",
        answer_url: name_url("#{metric.name}+#{COMPANY_NAME}")
      }
    end
  ...
  describe "exported json relation metric answer" do
