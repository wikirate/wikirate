    ...
    context "with fixed company" do
      ...
      specify "year, topic, bookmark, and updated" do
        Timecop.freeze(Deckorate::HAPPY_BIRTHDAY) do
          expect(
            search(year: "1991", topic: %i[esg_topic environment].cardname, bookmark: :bookmark, updated: :week)
      ...
      specify "all in" do
        Timecop.freeze(Deckorate::HAPPY_BIRTHDAY) do
          expect(
            search(year: "1992", topic: %i[esg_topic environment].cardname, bookmark: :bookmark, updated: :month,
