...
RSpec.describe Card::Set::TypePlusRight::Dataset::DataSubset do
  describe "data_subsets" do
    ...
    it "adds its companies to parent dataset" do
      ...
      data_subset = create_data_subset wikirate_company: new_companies.to_pointer_content
      parent_companies = data_subset.parent_dataset_card.wikirate_company_card.item_names
