...
(function() {
  ...
  deckorate.calculator = {
    ...
    numKnown: function(list) {
      return formulajs.COUNTIF(list, "<>Unknown");
    },
...
(function() {
  ...
  decko.editorContentFunctionMap['._variablesEditor'] = function() {
  ...
  FormulaVariable = (function(superClass) {
    ...
    FormulaVariable.prototype.publishOptions = function() {
      ...
      if (this.allResearchedOptions()) {
        return list.html("<div class='faint'>(default)</div>");
      } else {
        ref = this.options();
        results = [];
        for (key in ref) {
...
(function() {
  ...
  decko.addEditor(".codemirror-editor-textarea", function() {
