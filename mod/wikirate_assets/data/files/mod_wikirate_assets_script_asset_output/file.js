...
(function() {
  ...
  $(document).ready(function() {
    $('body').on('click.collapse-next', '[data-bs-dismiss=collapse-next]', function() {
      return findCollapseTarget($(this)).collapse('toggle');
    });
    return $('body').on('click', '[data-bs-dismiss="collapse"]', function() {
      var $target;
  ...
  decko.slotReady(function(slot) {
    return slot.find('[data-bs-dismiss="collapse"], [data-bs-dismiss="collapse-next"]').each(function(i) {
...
(function() {
  decko.slotReady(function(slot) {
    return slot.find('[data-bs-dismiss="popover"]').popover();
  });
