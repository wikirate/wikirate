  ...
  describe 'rendering json in export mode' do
    ...
    context 'pointer card' do
      it 'should contain cards in the pointer card and its children' do
        ...
        is_expected.to include(name: "Elbert Hubbard", type: "Basic",
                               content: 'Do not take life too seriously.')
        is_expected.to include(name: "Elbert Hubbard+hello world",type: "Basic",
                               content: 'You will never get out of it alive.')
      end
    ...
    context 'search card' do
      it 'should contain cards from search card and its children' do
        ...
        @collection_card = Card.create! name: "search card",type_id:
          Card::SearchTypeID, content: %{{"left":"Elbert Hubbard"}}

        is_expected.to include(name: "search card",type: "Search",content:
          %{{"left":"Elbert Hubbard"}})
        is_expected.to include(name: "Elbert Hubbard+hello world",type: "Basic",content: 'You will never get out of it alive.')
