...
LinkThumbnailer.configure do |config|
  ...
  # |related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget|modal/i

  # Numbers of images to fetch. Fetching too many images will be slow.
  #
  config.image_limit = 0

  # Whether you want LinkThumbnailer to return image size and type or not.
  # Setting this value to false will increase performance since for each images,
  # LinkThumbnailer does not have to fetch its size and type.
  #
