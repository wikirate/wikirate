RSpec.describe Card::Set::TypePlusRight::Topic::Category do
  describe "creation" do
    let(:topic) { Card[%i[esg_topic social].cardname] }
    ...
    it "triggers updates to subtopic referers", as_bot: true do
      ...
      pointer.add_item %i[esg_topic environment].cardname
      pointer.save!
      ...
      expect(%i[esg_topic environment].cardname.card.metric_card.item_names).to include("Fred+dinosaurlabor")
    end
  end
end
