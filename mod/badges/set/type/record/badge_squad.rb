...
# all badges related to metric records
class BadgeSquad
  ...
  add_badge_line :check,
                 ...
                 check_pro: 50,
                 check_mate: 250,
                 &type_plus_right_count(:record, :checked_by, :refer_to)

  add_badge_line :update,
                 answer_chancer: 1,
                 answer_enhancer: 25,
                 answer_advancer: 100,
                 &type_plus_right_count(:record, :value, :updated_by)

  add_badge_line :discuss,
                 commentator: 1,
                 commentary_team: 50,
                 expert_commentary: 250,
                 &type_plus_right_edited_count(:record, :discussion)
