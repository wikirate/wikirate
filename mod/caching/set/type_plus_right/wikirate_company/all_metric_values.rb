...
cache_expire_trigger TypePlusRight::MetricValue::Value,
                     on: :save do |changed_card|
  values_caches_affected_by changed_card
end

# ... a Metric Value (type) is renamed
cache_expire_trigger Type::MetricValue, on: :update do |changed_card|
  values_caches_affected_by changed_card
end

cache_expire_trigger Type::MetricValue,
