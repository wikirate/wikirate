// research.js.coffee
(function() {
  var addSourceItem, addToSourceContent, appendToDataUrl, appendToHref, appendToUrl, citedSources, closeSourceModal, demandYear, initialUrl, openAnswerFormBeforeAddingSource, openPdf, reloadSourceSlot, researchPath, revealOverlay, selectedSource, selectedYear, selectedYearInput, selectedYearNotResearched, tabPhase, toPhase;

  decko.editorInitFunctionMap["._removable-content-list ul"] = function() {
  ...
  decko.editorContentFunctionMap["._removable-content-list ul"] = function() {
    return decko.pointerContent(citedSources($(this)));
  };

  decko.slotReady(function(slot) {
    var newSource, success_in_project;
    if (slot.closest(".research-layout")[0]) {
      ...
      if (success_in_project[0] && $("._company-project-research")[0]) {
        return success_in_project.show();
      }
    }
  });
  ...
  $(document).ready(function() {
    ...
    $(".research-layout #main").on("click", '[data-dismiss="overlay"]', function(e) {
      var el;
      el = $(this);
    ...
    $(researchTabSelector).on("click", ".nav-link:not(.active)", function(e) {
    ...
    return $(".research-layout").on("click", "._copy_caught_source", function(e) {
      var link, sourceMark;
      link = $(this);
  ...
  closeSourceModal = function(el) {
    return el.closest("._modal-slot").find("._close-modal").trigger("click");
  };
  ...
  reloadSourceSlot = function(slot, content) {
    ...
    return slot.reloadSlot((slot.data('cardName')) + "?" + query);
  };
  ...
  citedSources = function(el) {
    return el.find('._removable-content-item').map(function() {
      return $(this).data('cardName');
    });
  };

  selectedYear = function() {
    return selectedYearInput().val();
  };

  selectedYearNotResearched = function() {
    return selectedYearInput().closest("._research-year-option").find(".not-researched")[0];
  };
  ...
  openPdf = function(sourceMark) {
    ...
    if (el[0] && sourceMark !== selectedSource) {
      url = researchPath("source_selector") + "?" + $.param({
        source: sourceMark
      });
      el.addClass("slotter");
      el[0].href = url;
...
(function() {
  ...
  decko.editorContentFunctionMap["._unknown-checkbox input:checked"] = function() {
    return this.val();
  };
...
// confirm.js.coffee
(function() {
  var answerReadyForYearChange, changeHiddenName, changeToYear, changeYearInAnswerForm, changeYearInSourceFilter, clearTab, confirmYearChange, editInProgress, fromResearched, tabPane, toResearched;
  ...
  changeToYear = function(year) {
    ...
    return changeYearInSourceFilter(year);
  };
